...
echo "=== Nest Jetstream Integration Test (Timed) ==="
...
# Step 7: Consumer (unlimited, background) + timed sleep
echo "[7/8] Running Jetstream consumer for ${DURATION_MINUTES} minute(s)..."
...
while [[ "$ELAPSED" -lt "$TOTAL_SECONDS" ]]; do
    ...
    echo "  [consumer] Running... ${ELAPSED}s elapsed, ${REMAINING}s remaining"
    SLEEP_INTERVAL=30
...
echo "  Timer expired. Stopping consumer..."
